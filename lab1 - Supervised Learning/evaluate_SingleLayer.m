...
% The Training Data (added bias)
Xtraining = [ones(1,size(Xt{1},2)); Xt{1}];

% The Test Data (added bias)
...
%learningRate = 0.000005; % Change this, Your learningrate

% Dataset 2
%numIterations = 80000; % Change this, Numner of iterations (Epochs)
%learningRate = 0.00000005; % Change this, Your learningrate

% Dataset 3
numIterations = 10000; % Change this, Numner of iterations (Epochs)
learningRate = 0.000000005; % Change this, Your learningrate
...
W0 = -a + (a+a)*rand(size(Dt{1},1),size(Xtraining,1))
%W0
